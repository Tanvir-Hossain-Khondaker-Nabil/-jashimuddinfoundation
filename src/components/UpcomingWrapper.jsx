...
const UpcomingWrapper = () => {
  ...
  useEffect(() => {
    ...
    const fetchEvents = async () => {
      try {
        const response = await axios.get("https://jashimuddinfoundation.com/admin/public/api/events");
              ...
              <div className="item" key={event.id}>
                <div className="upcoming-item">
                  <div className="upcoming-img">
                    <img src={`https://jashimuddinfoundation.com/admin/public/${event.photo}`} alt={event.title} />
                  </div>
